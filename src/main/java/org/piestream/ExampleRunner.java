...
public class ExampleRunner {
    ...
    public static String buildSimpleJoinQuery(int Col,int DENSITY) {
        ...
        for (int i = 1; i <= Col; i++) {
            ...
            defineBuilder.append("A").append(i).append(" AS a_").append(i).append(" >= ").append(DENSITY);
        }
...
//                    .append(" meets;met-by;overlapped-by;overlaps;started-by;starts;during;contains;finishes;finished-by;equals ")
    ...
    public static long buildRunner(int col, long row, String basePath, WindowType windowType,int DENSITY) {
        Schema schema = ExampleRunner.buildSchema(col);
        String query = ExampleRunner.buildSimpleJoinQuery(col,  DENSITY); // Assuming buildQuery is used here
...
//        String basePath = "/Users/czq/Code/TPstream0/TPStream_DAPD/jepc-v2/";
        ...
        String basePath = "/home/uzi/Code/TPS/jepc-v2/data/";
        ...
        for (int col : colList) {
            ...
            for (long row : rowList) {
                ...
                Long processedTime = buildRunner(col, row, basePath, windowType,  density);
...
// java  -Xms12g -Xmx12g  -cp "target/classes:lib/*" org.piestream.Main
//java  -Xms12g -Xmx12g   -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath="test_service_jvmDump.hprof"  -cp "target/classes:lib/*" org.piestream.Main
